...
import styles from './Concon.module.css'
import { MdAlternateEmail } from "react-icons/md";
import { SiWhatsapp } from "react-icons/si";

function Concon() {
  return (
    <div className={styles.concon_wrapper}>
        <div className={styles.concon_con}>
            <div className={styles.concon_info}>
                <h3>Get in touch</h3>
                <p className={styles.concon_desc}>
            ...
            <div className={styles.concon_form}>
                <form action="">
